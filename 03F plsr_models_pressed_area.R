...
pressed_spec_EL_agg_train<-readRDS("ProcessedSpectralData/pressed_spec_EL_agg_train.rds")
pressed_spec_EL_agg_test<-readRDS("ProcessedSpectralData/pressed_spec_EL_agg_test.rds")

################################################
## building calibration models

perC_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$C_area~as.matrix(pressed_spec_EL_agg_train),
...
perC_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$C_area))
perC_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[perC_area_pressed_valid],
                                 Species=meta(pressed_spec_EL_agg_train)$Species[perC_area_pressed_valid],
                                 Project=meta(pressed_spec_EL_agg_train)$Project[perC_area_pressed_valid],
                                 Stage=meta(pressed_spec_EL_agg_train)$Stage[perC_area_pressed_valid],
                                 GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[perC_area_pressed_valid],
                                 measured=meta(pressed_spec_EL_agg_train)$C_area[perC_area_pressed_valid],
...
perN_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$N_area~as.matrix(pressed_spec_EL_agg_train),
                      ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_perN_area_pressed <- selectNcomp(perN_area_pressed, method = "onesigma", plot = FALSE)
perN_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$N_area))
perN_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[perN_area_pressed_valid],
                                 Species=meta(pressed_spec_EL_agg_train)$Species[perN_area_pressed_valid],
                                 Project=meta(pressed_spec_EL_agg_train)$Project[perN_area_pressed_valid],
                                 Stage=meta(pressed_spec_EL_agg_train)$Stage[perN_area_pressed_valid],
                                 GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[perN_area_pressed_valid],
                                 measured=meta(pressed_spec_EL_agg_train)$N_area[perN_area_pressed_valid],
...
chlA_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$chlA_area~as.matrix(pressed_spec_EL_agg_train),
                      ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_chlA_area_pressed <- selectNcomp(chlA_area_pressed, method = "onesigma", plot = FALSE)
chlA_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$chlA_area))
chlA_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[chlA_area_pressed_valid],
                                 Species=meta(pressed_spec_EL_agg_train)$Species[chlA_area_pressed_valid],
                                 Project=meta(pressed_spec_EL_agg_train)$Project[chlA_area_pressed_valid],
                                 Stage=meta(pressed_spec_EL_agg_train)$Stage[chlA_area_pressed_valid],
                                 GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[chlA_area_pressed_valid],
                                 measured=meta(pressed_spec_EL_agg_train)$chlA_area[chlA_area_pressed_valid],
...
chlB_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$chlB_area~as.matrix(pressed_spec_EL_agg_train),
                      ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_chlB_area_pressed <- selectNcomp(chlB_area_pressed, method = "onesigma", plot = FALSE)
chlB_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$chlB_area))
chlB_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[chlB_area_pressed_valid],
                                 Species=meta(pressed_spec_EL_agg_train)$Species[chlB_area_pressed_valid],
                                 Project=meta(pressed_spec_EL_agg_train)$Project[chlB_area_pressed_valid],
                                 Stage=meta(pressed_spec_EL_agg_train)$Stage[chlB_area_pressed_valid],
                                 GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[chlB_area_pressed_valid],
                                 measured=meta(pressed_spec_EL_agg_train)$chlB_area[chlB_area_pressed_valid],
...
car_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$car_area~as.matrix(pressed_spec_EL_agg_train),
                     ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_car_area_pressed <- selectNcomp(car_area_pressed, method = "onesigma", plot = FALSE)
car_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$car_area))
car_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[car_area_pressed_valid],
                                Species=meta(pressed_spec_EL_agg_train)$Species[car_area_pressed_valid],
                                Project=meta(pressed_spec_EL_agg_train)$Project[car_area_pressed_valid],
                                Stage=meta(pressed_spec_EL_agg_train)$Stage[car_area_pressed_valid],
                                GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[car_area_pressed_valid],
                                measured=meta(pressed_spec_EL_agg_train)$car_area[car_area_pressed_valid],
...
solubles_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$solubles_area~as.matrix(pressed_spec_EL_agg_train),
                          ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_solubles_area_pressed <- selectNcomp(solubles_area_pressed, method = "onesigma", plot = FALSE)
solubles_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$solubles_area))
solubles_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[solubles_area_pressed_valid],
                                     Species=meta(pressed_spec_EL_agg_train)$Species[solubles_area_pressed_valid],
                                     Project=meta(pressed_spec_EL_agg_train)$Project[solubles_area_pressed_valid],
                                     Stage=meta(pressed_spec_EL_agg_train)$Stage[solubles_area_pressed_valid],
                                     GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[solubles_area_pressed_valid],
                                     measured=meta(pressed_spec_EL_agg_train)$solubles_area[solubles_area_pressed_valid],
...
hemicellulose_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$hemicellulose_area~as.matrix(pressed_spec_EL_agg_train),
                               ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_hemicellulose_area_pressed <- selectNcomp(hemicellulose_area_pressed, method = "onesigma", plot = FALSE)
hemicellulose_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$hemicellulose_area))
hemicellulose_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[hemicellulose_area_pressed_valid],
                                          Species=meta(pressed_spec_EL_agg_train)$Species[hemicellulose_area_pressed_valid],
                                          Project=meta(pressed_spec_EL_agg_train)$Project[hemicellulose_area_pressed_valid],
                                          Stage=meta(pressed_spec_EL_agg_train)$Stage[hemicellulose_area_pressed_valid],
                                          GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[hemicellulose_area_pressed_valid],
                                          measured=meta(pressed_spec_EL_agg_train)$hemicellulose_area[hemicellulose_area_pressed_valid],
...
cellulose_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$cellulose_area~as.matrix(pressed_spec_EL_agg_train),
                           ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_cellulose_area_pressed <- selectNcomp(cellulose_area_pressed, method = "onesigma", plot = FALSE)
cellulose_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$cellulose_area))
cellulose_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[cellulose_area_pressed_valid],
                                      Species=meta(pressed_spec_EL_agg_train)$Species[cellulose_area_pressed_valid],
                                      Project=meta(pressed_spec_EL_agg_train)$Project[cellulose_area_pressed_valid],
                                      Stage=meta(pressed_spec_EL_agg_train)$Stage[cellulose_area_pressed_valid],
                                      GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[cellulose_area_pressed_valid],
                                      measured=meta(pressed_spec_EL_agg_train)$cellulose_area[cellulose_area_pressed_valid],
...
lignin_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$lignin_area~as.matrix(pressed_spec_EL_agg_train),
                        ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_lignin_area_pressed <- selectNcomp(lignin_area_pressed, method = "onesigma", plot = FALSE)
lignin_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$lignin_area))
lignin_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[lignin_area_pressed_valid],
                                   Species=meta(pressed_spec_EL_agg_train)$Species[lignin_area_pressed_valid],
                                   Project=meta(pressed_spec_EL_agg_train)$Project[lignin_area_pressed_valid],
                                   Stage=meta(pressed_spec_EL_agg_train)$Stage[lignin_area_pressed_valid],
                                   GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[lignin_area_pressed_valid],
                                   measured=meta(pressed_spec_EL_agg_train)$lignin_area[lignin_area_pressed_valid],
...
Al_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$Al_area~as.matrix(pressed_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Al_area_pressed <- selectNcomp(Al_area_pressed, method = "onesigma", plot = FALSE)
Al_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$Al_area))
Al_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[Al_area_pressed_valid],
                               Species=meta(pressed_spec_EL_agg_train)$Species[Al_area_pressed_valid],
                               Project=meta(pressed_spec_EL_agg_train)$Project[Al_area_pressed_valid],
                               Stage=meta(pressed_spec_EL_agg_train)$Stage[Al_area_pressed_valid],
                               GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[Al_area_pressed_valid],
                               measured=meta(pressed_spec_EL_agg_train)$Al_area[Al_area_pressed_valid],
...
Ca_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$Ca_area~as.matrix(pressed_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Ca_area_pressed <- selectNcomp(Ca_area_pressed, method = "onesigma", plot = FALSE)
Ca_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$Ca_area))
Ca_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[Ca_area_pressed_valid],
                               Species=meta(pressed_spec_EL_agg_train)$Species[Ca_area_pressed_valid],
                               Project=meta(pressed_spec_EL_agg_train)$Project[Ca_area_pressed_valid],
                               Stage=meta(pressed_spec_EL_agg_train)$Stage[Ca_area_pressed_valid],
                               GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[Ca_area_pressed_valid],
                               measured=meta(pressed_spec_EL_agg_train)$Ca_area[Ca_area_pressed_valid],
...
Cu_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$Cu_area~as.matrix(pressed_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Cu_area_pressed <- selectNcomp(Cu_area_pressed, method = "onesigma", plot = FALSE)
Cu_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$Cu_area))
Cu_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[Cu_area_pressed_valid],
                               Species=meta(pressed_spec_EL_agg_train)$Species[Cu_area_pressed_valid],
                               Project=meta(pressed_spec_EL_agg_train)$Project[Cu_area_pressed_valid],
                               Stage=meta(pressed_spec_EL_agg_train)$Stage[Cu_area_pressed_valid],
                               GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[Cu_area_pressed_valid],
                               measured=meta(pressed_spec_EL_agg_train)$Cu_area[Cu_area_pressed_valid],
...
Fe_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$Fe_area~as.matrix(pressed_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Fe_area_pressed <- selectNcomp(Fe_area_pressed, method = "onesigma", plot = FALSE)
Fe_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$Fe_area))
Fe_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[Fe_area_pressed_valid],
                               Species=meta(pressed_spec_EL_agg_train)$Species[Fe_area_pressed_valid],
                               Project=meta(pressed_spec_EL_agg_train)$Project[Fe_area_pressed_valid],
                               Stage=meta(pressed_spec_EL_agg_train)$Stage[Fe_area_pressed_valid],
                               GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[Fe_area_pressed_valid],
                               measured=meta(pressed_spec_EL_agg_train)$Fe_area[Fe_area_pressed_valid],
...
K_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$K_area~as.matrix(pressed_spec_EL_agg_train),
                   ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_K_area_pressed <- selectNcomp(K_area_pressed, method = "onesigma", plot = FALSE)
K_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$K_area))
K_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[K_area_pressed_valid],
                              Species=meta(pressed_spec_EL_agg_train)$Species[K_area_pressed_valid],
                              Project=meta(pressed_spec_EL_agg_train)$Project[K_area_pressed_valid],
                              Stage=meta(pressed_spec_EL_agg_train)$Stage[K_area_pressed_valid],
                              GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[K_area_pressed_valid],
                              measured=meta(pressed_spec_EL_agg_train)$K_area[K_area_pressed_valid],
...
Mg_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$Mg_area~as.matrix(pressed_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Mg_area_pressed <- selectNcomp(Mg_area_pressed, method = "onesigma", plot = FALSE)
Mg_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$Mg_area))
Mg_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[Mg_area_pressed_valid],
                               Species=meta(pressed_spec_EL_agg_train)$Species[Mg_area_pressed_valid],
                               Project=meta(pressed_spec_EL_agg_train)$Project[Mg_area_pressed_valid],
                               Stage=meta(pressed_spec_EL_agg_train)$Stage[Mg_area_pressed_valid],
                               GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[Mg_area_pressed_valid],
                               measured=meta(pressed_spec_EL_agg_train)$Mg_area[Mg_area_pressed_valid],
...
Mn_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$Mn_area~as.matrix(pressed_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Mn_area_pressed <- selectNcomp(Mn_area_pressed, method = "onesigma", plot = FALSE)
Mn_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$Mn_area))
Mn_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[Mn_area_pressed_valid],
                               Species=meta(pressed_spec_EL_agg_train)$Species[Mn_area_pressed_valid],
                               Project=meta(pressed_spec_EL_agg_train)$Project[Mn_area_pressed_valid],
                               Stage=meta(pressed_spec_EL_agg_train)$Stage[Mn_area_pressed_valid],
                               GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[Mn_area_pressed_valid],
                               measured=meta(pressed_spec_EL_agg_train)$Mn_area[Mn_area_pressed_valid],
...
Na_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$Na_area~as.matrix(pressed_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Na_area_pressed <- selectNcomp(Na_area_pressed, method = "onesigma", plot = FALSE)
Na_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$Na_area))
Na_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[Na_area_pressed_valid],
                               Species=meta(pressed_spec_EL_agg_train)$Species[Na_area_pressed_valid],
                               Project=meta(pressed_spec_EL_agg_train)$Project[Na_area_pressed_valid],
                               Stage=meta(pressed_spec_EL_agg_train)$Stage[Na_area_pressed_valid],
                               GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[Na_area_pressed_valid],
                               measured=meta(pressed_spec_EL_agg_train)$Na_area[Na_area_pressed_valid],
...
P_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$P_area~as.matrix(pressed_spec_EL_agg_train),
                   ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_P_area_pressed <- selectNcomp(P_area_pressed, method = "onesigma", plot = FALSE)
P_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$P_area))
P_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[P_area_pressed_valid],
                              Species=meta(pressed_spec_EL_agg_train)$Species[P_area_pressed_valid],
                              Project=meta(pressed_spec_EL_agg_train)$Project[P_area_pressed_valid],
                              Stage=meta(pressed_spec_EL_agg_train)$Stage[P_area_pressed_valid],
                              GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[P_area_pressed_valid],
                              measured=meta(pressed_spec_EL_agg_train)$P_area[P_area_pressed_valid],
...
Zn_area_pressed<-plsr(meta(pressed_spec_EL_agg_train)$Zn_area~as.matrix(pressed_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Zn_area_pressed <- selectNcomp(Zn_area_pressed, method = "onesigma", plot = FALSE)
Zn_area_pressed_valid <- which(!is.na(meta(pressed_spec_EL_agg_train)$Zn_area))
Zn_area_pressed_pred<-data.frame(ID=meta(pressed_spec_EL_agg_train)$ID[Zn_area_pressed_valid],
                               Species=meta(pressed_spec_EL_agg_train)$Species[Zn_area_pressed_valid],
                               Project=meta(pressed_spec_EL_agg_train)$Project[Zn_area_pressed_valid],
                               Stage=meta(pressed_spec_EL_agg_train)$Stage[Zn_area_pressed_valid],
                               GrowthForm=meta(pressed_spec_EL_agg_train)$GrowthForm[Zn_area_pressed_valid],
                               measured=meta(pressed_spec_EL_agg_train)$Zn_area[Zn_area_pressed_valid],
...
for(i in 1:nreps){
  ...
  n_cal_spec_pressed<-nrow(pressed_spec_EL_agg_train)
  ...
  calib_jack_pressed<-pressed_spec_EL_agg_train[train_jack_pressed]
  val_jack_pressed<-pressed_spec_EL_agg_train[test_jack_pressed]
...
solubles_area_jack_pred_pressed<-apply.coefs(solubles_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
solubles_area_jack_df_pressed<-data.frame(pred_mean=solubles_area_jack_stat_pressed[,1],
                                        ...
                                        Measured=meta(pressed_spec_EL_agg_test)$solubles_area,
                                        ncomp=ncomp_solubles_area_pressed,
                                        Project=meta(pressed_spec_EL_agg_test)$Project,
                                        GrowthForm=meta(pressed_spec_EL_agg_test)$GrowthForm,
                                        Discoloration=meta(pressed_spec_EL_agg_test)$Discoloration,
                                        ID=meta(pressed_spec_EL_agg_test)$ID)

hemicellulose_area_jack_pred_pressed<-apply.coefs(hemicellulose_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
hemicellulose_area_jack_df_pressed<-data.frame(pred_mean=hemicellulose_area_jack_stat_pressed[,1],
                                             ...
                                             Measured=meta(pressed_spec_EL_agg_test)$hemicellulose_area,
...
cellulose_area_jack_pred_pressed<-apply.coefs(cellulose_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
cellulose_area_jack_df_pressed<-data.frame(pred_mean=cellulose_area_jack_stat_pressed[,1],
                                         ...
                                         Measured=meta(pressed_spec_EL_agg_test)$cellulose_area,
...
lignin_area_jack_pred_pressed<-apply.coefs(lignin_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
lignin_area_jack_df_pressed<-data.frame(pred_mean=lignin_area_jack_stat_pressed[,1],
                                      ...
                                      Measured=meta(pressed_spec_EL_agg_test)$lignin_area,
...
perC_area_jack_pred_pressed<-apply.coefs(perC_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
perC_area_jack_df_pressed<-data.frame(pred_mean=perC_area_jack_stat_pressed[,1],
                                    ...
                                    Measured=meta(pressed_spec_EL_agg_test)$C_area,
...
perN_area_jack_pred_pressed<-apply.coefs(perN_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
perN_area_jack_df_pressed<-data.frame(pred_mean=perN_area_jack_stat_pressed[,1],
                                    ...
                                    Measured=meta(pressed_spec_EL_agg_test)$N_area,
...
chlA_area_jack_pred_pressed<-apply.coefs(chlA_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
chlA_area_jack_df_pressed<-data.frame(pred_mean=chlA_area_jack_stat_pressed[,1],
                                    ...
                                    Measured=meta(pressed_spec_EL_agg_test)$chlA_area,
...
chlB_area_jack_pred_pressed<-apply.coefs(chlB_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
chlB_area_jack_df_pressed<-data.frame(pred_mean=chlB_area_jack_stat_pressed[,1],
                                    ...
                                    Measured=meta(pressed_spec_EL_agg_test)$chlB_area,
...
car_area_jack_pred_pressed<-apply.coefs(car_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
car_area_jack_df_pressed<-data.frame(pred_mean=car_area_jack_stat_pressed[,1],
                                   ...
                                   Measured=meta(pressed_spec_EL_agg_test)$car_area,
...
Al_area_jack_pred_pressed<-apply.coefs(Al_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
Al_area_jack_df_pressed<-data.frame(pred_mean=Al_area_jack_stat_pressed[,1],
                                  ...
                                  Measured=meta(pressed_spec_EL_agg_test)$Al_area,
...
Ca_area_jack_pred_pressed<-apply.coefs(Ca_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
Ca_area_jack_df_pressed<-data.frame(pred_mean=Ca_area_jack_stat_pressed[,1],
                                  ...
                                  Measured=meta(pressed_spec_EL_agg_test)$Ca_area,
...
Cu_area_jack_pred_pressed<-apply.coefs(Cu_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
Cu_area_jack_df_pressed<-data.frame(pred_mean=Cu_area_jack_stat_pressed[,1],
                                  ...
                                  Measured=meta(pressed_spec_EL_agg_test)$Cu_area,
...
Fe_area_jack_pred_pressed<-apply.coefs(Fe_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
Fe_area_jack_df_pressed<-data.frame(pred_mean=Fe_area_jack_stat_pressed[,1],
                                  ...
                                  Measured=meta(pressed_spec_EL_agg_test)$Fe_area,
...
K_area_jack_pred_pressed<-apply.coefs(K_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
K_area_jack_df_pressed<-data.frame(pred_mean=K_area_jack_stat_pressed[,1],
                                 ...
                                 Measured=meta(pressed_spec_EL_agg_test)$K_area,
...
Mg_area_jack_pred_pressed<-apply.coefs(Mg_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
Mg_area_jack_df_pressed<-data.frame(pred_mean=Mg_area_jack_stat_pressed[,1],
                                  ...
                                  Measured=meta(pressed_spec_EL_agg_test)$Mg_area,
...
Mn_area_jack_pred_pressed<-apply.coefs(Mn_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
Mn_area_jack_df_pressed<-data.frame(pred_mean=Mn_area_jack_stat_pressed[,1],
                                  ...
                                  Measured=meta(pressed_spec_EL_agg_test)$Mn_area,
...
Na_area_jack_pred_pressed<-apply.coefs(Na_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
Na_area_jack_df_pressed<-data.frame(pred_mean=Na_area_jack_stat_pressed[,1],
                                  ...
                                  Measured=meta(pressed_spec_EL_agg_test)$Na_area,
...
P_area_jack_pred_pressed<-apply.coefs(P_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
P_area_jack_df_pressed<-data.frame(pred_mean=P_area_jack_stat_pressed[,1],
                                 ...
                                 Measured=meta(pressed_spec_EL_agg_test)$P_area,
...
Zn_area_jack_pred_pressed<-apply.coefs(Zn_area_jack_coefs_pressed,as.matrix(pressed_spec_EL_agg_test))
...
Zn_area_jack_df_pressed<-data.frame(pred_mean=Zn_area_jack_stat_pressed[,1],
                                  ...
                                  Measured=meta(pressed_spec_EL_agg_test)$Zn_area,
