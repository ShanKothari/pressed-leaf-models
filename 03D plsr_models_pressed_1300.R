...
## rerun pressed-leaf models after fixing code to 
## use sensor-matched data
...
pressed_1300_jack_coef_list<-list(solubles=solubles_jack_coefs_pressed_1300,
                             hemicellulose=hemicellulose_jack_coefs_pressed_1300,
                             cellulose=cellulose_jack_coefs_pressed_1300,
                             lignin=lignin_jack_coefs_pressed_1300,
                             chlA=chlA_jack_coefs_pressed_1300,
                             chlB=chlB_jack_coefs_pressed_1300,
                             car=car_jack_coefs_pressed_1300,
                             perN=perN_jack_coefs_pressed_1300,
                             perC=perC_jack_coefs_pressed_1300,
                             EWT=EWT_jack_coefs_pressed_1300,
                             LDMC=LDMC_jack_coefs_pressed_1300,
                             LMA=LMA_jack_coefs_pressed_1300,
...
pressed_1300_jack_df_list<-list(solubles=solubles_jack_df_pressed_1300,
                           hemicellulose=hemicellulose_jack_df_pressed_1300,
                           cellulose=cellulose_jack_df_pressed_1300,
                           lignin=lignin_jack_df_pressed_1300,
                           chlA=chlA_jack_df_pressed_1300,
                           chlB=chlB_jack_df_pressed_1300,
                           car=car_jack_df_pressed_1300,
                           perN=perN_jack_df_pressed_1300,
                           perC=perC_jack_df_pressed_1300,
                           EWT=EWT_jack_df_pressed_1300,
                           LDMC=LDMC_jack_df_pressed_1300,
                           LMA=LMA_jack_df_pressed_1300,
