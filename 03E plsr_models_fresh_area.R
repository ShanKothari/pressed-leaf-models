...
perC_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$C_area~as.matrix(fresh_spec_EL_agg_train),
...
perC_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$C_area))
perC_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[perC_area_fresh_valid],
                                 Species=meta(fresh_spec_EL_agg_train)$Species[perC_area_fresh_valid],
                                 Project=meta(fresh_spec_EL_agg_train)$Project[perC_area_fresh_valid],
                                 Stage=meta(fresh_spec_EL_agg_train)$Stage[perC_area_fresh_valid],
                                 GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[perC_area_fresh_valid],
                                 measured=meta(fresh_spec_EL_agg_train)$C_area[perC_area_fresh_valid],
...
perN_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$N_area~as.matrix(fresh_spec_EL_agg_train),
                      ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_perN_area_fresh <- selectNcomp(perN_area_fresh, method = "onesigma", plot = FALSE)
perN_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$N_area))
perN_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[perN_area_fresh_valid],
                                 Species=meta(fresh_spec_EL_agg_train)$Species[perN_area_fresh_valid],
                                 Project=meta(fresh_spec_EL_agg_train)$Project[perN_area_fresh_valid],
                                 Stage=meta(fresh_spec_EL_agg_train)$Stage[perN_area_fresh_valid],
                                 GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[perN_area_fresh_valid],
                                 measured=meta(fresh_spec_EL_agg_train)$N_area[perN_area_fresh_valid],
...
chlA_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$chlA_area~as.matrix(fresh_spec_EL_agg_train),
                      ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_chlA_area_fresh <- selectNcomp(chlA_area_fresh, method = "onesigma", plot = FALSE)
chlA_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$chlA_area))
chlA_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[chlA_area_fresh_valid],
                                 Species=meta(fresh_spec_EL_agg_train)$Species[chlA_area_fresh_valid],
                                 Project=meta(fresh_spec_EL_agg_train)$Project[chlA_area_fresh_valid],
                                 Stage=meta(fresh_spec_EL_agg_train)$Stage[chlA_area_fresh_valid],
                                 GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[chlA_area_fresh_valid],
                                 measured=meta(fresh_spec_EL_agg_train)$chlA_area[chlA_area_fresh_valid],
...
chlB_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$chlB_area~as.matrix(fresh_spec_EL_agg_train),
                      ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_chlB_area_fresh <- selectNcomp(chlB_area_fresh, method = "onesigma", plot = FALSE)
chlB_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$chlB_area))
chlB_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[chlB_area_fresh_valid],
                                 Species=meta(fresh_spec_EL_agg_train)$Species[chlB_area_fresh_valid],
                                 Project=meta(fresh_spec_EL_agg_train)$Project[chlB_area_fresh_valid],
                                 Stage=meta(fresh_spec_EL_agg_train)$Stage[chlB_area_fresh_valid],
                                 GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[chlB_area_fresh_valid],
                                 measured=meta(fresh_spec_EL_agg_train)$chlB_area[chlB_area_fresh_valid],
...
car_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$car_area~as.matrix(fresh_spec_EL_agg_train),
                     ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_car_area_fresh <- selectNcomp(car_area_fresh, method = "onesigma", plot = FALSE)
car_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$car_area))
car_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[car_area_fresh_valid],
                                Species=meta(fresh_spec_EL_agg_train)$Species[car_area_fresh_valid],
                                Project=meta(fresh_spec_EL_agg_train)$Project[car_area_fresh_valid],
                                Stage=meta(fresh_spec_EL_agg_train)$Stage[car_area_fresh_valid],
                                GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[car_area_fresh_valid],
                                measured=meta(fresh_spec_EL_agg_train)$car_area[car_area_fresh_valid],
...
solubles_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$solubles_area~as.matrix(fresh_spec_EL_agg_train),
                          ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_solubles_area_fresh <- selectNcomp(solubles_area_fresh, method = "onesigma", plot = FALSE)
solubles_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$solubles_area))
solubles_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[solubles_area_fresh_valid],
                                     Species=meta(fresh_spec_EL_agg_train)$Species[solubles_area_fresh_valid],
                                     Project=meta(fresh_spec_EL_agg_train)$Project[solubles_area_fresh_valid],
                                     Stage=meta(fresh_spec_EL_agg_train)$Stage[solubles_area_fresh_valid],
                                     GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[solubles_area_fresh_valid],
                                     measured=meta(fresh_spec_EL_agg_train)$solubles_area[solubles_area_fresh_valid],
...
hemicellulose_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$hemicellulose_area~as.matrix(fresh_spec_EL_agg_train),
                               ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_hemicellulose_area_fresh <- selectNcomp(hemicellulose_area_fresh, method = "onesigma", plot = FALSE)
hemicellulose_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$hemicellulose_area))
hemicellulose_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[hemicellulose_area_fresh_valid],
                                          Species=meta(fresh_spec_EL_agg_train)$Species[hemicellulose_area_fresh_valid],
                                          Project=meta(fresh_spec_EL_agg_train)$Project[hemicellulose_area_fresh_valid],
                                          Stage=meta(fresh_spec_EL_agg_train)$Stage[hemicellulose_area_fresh_valid],
                                          GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[hemicellulose_area_fresh_valid],
                                          measured=meta(fresh_spec_EL_agg_train)$hemicellulose_area[hemicellulose_area_fresh_valid],
...
cellulose_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$cellulose_area~as.matrix(fresh_spec_EL_agg_train),
                           ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_cellulose_area_fresh <- selectNcomp(cellulose_area_fresh, method = "onesigma", plot = FALSE)
cellulose_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$cellulose_area))
cellulose_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[cellulose_area_fresh_valid],
                                      Species=meta(fresh_spec_EL_agg_train)$Species[cellulose_area_fresh_valid],
                                      Project=meta(fresh_spec_EL_agg_train)$Project[cellulose_area_fresh_valid],
                                      Stage=meta(fresh_spec_EL_agg_train)$Stage[cellulose_area_fresh_valid],
                                      GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[cellulose_area_fresh_valid],
                                      measured=meta(fresh_spec_EL_agg_train)$cellulose_area[cellulose_area_fresh_valid],
...
lignin_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$lignin_area~as.matrix(fresh_spec_EL_agg_train),
                        ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_lignin_area_fresh <- selectNcomp(lignin_area_fresh, method = "onesigma", plot = FALSE)
lignin_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$lignin_area))
lignin_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[lignin_area_fresh_valid],
                                   Species=meta(fresh_spec_EL_agg_train)$Species[lignin_area_fresh_valid],
                                   Project=meta(fresh_spec_EL_agg_train)$Project[lignin_area_fresh_valid],
                                   Stage=meta(fresh_spec_EL_agg_train)$Stage[lignin_area_fresh_valid],
                                   GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[lignin_area_fresh_valid],
                                   measured=meta(fresh_spec_EL_agg_train)$lignin_area[lignin_area_fresh_valid],
...
Al_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$Al_area~as.matrix(fresh_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Al_area_fresh <- selectNcomp(Al_area_fresh, method = "onesigma", plot = FALSE)
Al_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$Al_area))
Al_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[Al_area_fresh_valid],
                               Species=meta(fresh_spec_EL_agg_train)$Species[Al_area_fresh_valid],
                               Project=meta(fresh_spec_EL_agg_train)$Project[Al_area_fresh_valid],
                               Stage=meta(fresh_spec_EL_agg_train)$Stage[Al_area_fresh_valid],
                               GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[Al_area_fresh_valid],
                               measured=meta(fresh_spec_EL_agg_train)$Al_area[Al_area_fresh_valid],
...
Ca_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$Ca_area~as.matrix(fresh_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Ca_area_fresh <- selectNcomp(Ca_area_fresh, method = "onesigma", plot = FALSE)
Ca_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$Ca_area))
Ca_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[Ca_area_fresh_valid],
                               Species=meta(fresh_spec_EL_agg_train)$Species[Ca_area_fresh_valid],
                               Project=meta(fresh_spec_EL_agg_train)$Project[Ca_area_fresh_valid],
                               Stage=meta(fresh_spec_EL_agg_train)$Stage[Ca_area_fresh_valid],
                               GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[Ca_area_fresh_valid],
                               measured=meta(fresh_spec_EL_agg_train)$Ca_area[Ca_area_fresh_valid],
...
Cu_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$Cu_area~as.matrix(fresh_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Cu_area_fresh <- selectNcomp(Cu_area_fresh, method = "onesigma", plot = FALSE)
Cu_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$Cu_area))
Cu_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[Cu_area_fresh_valid],
                               Species=meta(fresh_spec_EL_agg_train)$Species[Cu_area_fresh_valid],
                               Project=meta(fresh_spec_EL_agg_train)$Project[Cu_area_fresh_valid],
                               Stage=meta(fresh_spec_EL_agg_train)$Stage[Cu_area_fresh_valid],
                               GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[Cu_area_fresh_valid],
                               measured=meta(fresh_spec_EL_agg_train)$Cu_area[Cu_area_fresh_valid],
...
Fe_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$Fe_area~as.matrix(fresh_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Fe_area_fresh <- selectNcomp(Fe_area_fresh, method = "onesigma", plot = FALSE)
Fe_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$Fe_area))
Fe_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[Fe_area_fresh_valid],
                               Species=meta(fresh_spec_EL_agg_train)$Species[Fe_area_fresh_valid],
                               Project=meta(fresh_spec_EL_agg_train)$Project[Fe_area_fresh_valid],
                               Stage=meta(fresh_spec_EL_agg_train)$Stage[Fe_area_fresh_valid],
                               GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[Fe_area_fresh_valid],
                               measured=meta(fresh_spec_EL_agg_train)$Fe_area[Fe_area_fresh_valid],
...
K_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$K_area~as.matrix(fresh_spec_EL_agg_train),
                   ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_K_area_fresh <- selectNcomp(K_area_fresh, method = "onesigma", plot = FALSE)
K_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$K_area))
K_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[K_area_fresh_valid],
                              Species=meta(fresh_spec_EL_agg_train)$Species[K_area_fresh_valid],
                              Project=meta(fresh_spec_EL_agg_train)$Project[K_area_fresh_valid],
                              Stage=meta(fresh_spec_EL_agg_train)$Stage[K_area_fresh_valid],
                              GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[K_area_fresh_valid],
                              measured=meta(fresh_spec_EL_agg_train)$K_area[K_area_fresh_valid],
...
Mg_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$Mg_area~as.matrix(fresh_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Mg_area_fresh <- selectNcomp(Mg_area_fresh, method = "onesigma", plot = FALSE)
Mg_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$Mg_area))
Mg_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[Mg_area_fresh_valid],
                               Species=meta(fresh_spec_EL_agg_train)$Species[Mg_area_fresh_valid],
                               Project=meta(fresh_spec_EL_agg_train)$Project[Mg_area_fresh_valid],
                               Stage=meta(fresh_spec_EL_agg_train)$Stage[Mg_area_fresh_valid],
                               GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[Mg_area_fresh_valid],
                               measured=meta(fresh_spec_EL_agg_train)$Mg_area[Mg_area_fresh_valid],
...
Mn_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$Mn_area~as.matrix(fresh_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Mn_area_fresh <- selectNcomp(Mn_area_fresh, method = "onesigma", plot = FALSE)
Mn_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$Mn_area))
Mn_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[Mn_area_fresh_valid],
                               Species=meta(fresh_spec_EL_agg_train)$Species[Mn_area_fresh_valid],
                               Project=meta(fresh_spec_EL_agg_train)$Project[Mn_area_fresh_valid],
                               Stage=meta(fresh_spec_EL_agg_train)$Stage[Mn_area_fresh_valid],
                               GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[Mn_area_fresh_valid],
                               measured=meta(fresh_spec_EL_agg_train)$Mn_area[Mn_area_fresh_valid],
...
Na_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$Na_area~as.matrix(fresh_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Na_area_fresh <- selectNcomp(Na_area_fresh, method = "onesigma", plot = FALSE)
Na_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$Na_area))
Na_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[Na_area_fresh_valid],
                               Species=meta(fresh_spec_EL_agg_train)$Species[Na_area_fresh_valid],
                               Project=meta(fresh_spec_EL_agg_train)$Project[Na_area_fresh_valid],
                               Stage=meta(fresh_spec_EL_agg_train)$Stage[Na_area_fresh_valid],
                               GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[Na_area_fresh_valid],
                               measured=meta(fresh_spec_EL_agg_train)$Na_area[Na_area_fresh_valid],
...
P_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$P_area~as.matrix(fresh_spec_EL_agg_train),
                   ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_P_area_fresh <- selectNcomp(P_area_fresh, method = "onesigma", plot = FALSE)
P_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$P_area))
P_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[P_area_fresh_valid],
                              Species=meta(fresh_spec_EL_agg_train)$Species[P_area_fresh_valid],
                              Project=meta(fresh_spec_EL_agg_train)$Project[P_area_fresh_valid],
                              Stage=meta(fresh_spec_EL_agg_train)$Stage[P_area_fresh_valid],
                              GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[P_area_fresh_valid],
                              measured=meta(fresh_spec_EL_agg_train)$P_area[P_area_fresh_valid],
...
Zn_area_fresh<-plsr(meta(fresh_spec_EL_agg_train)$Zn_area~as.matrix(fresh_spec_EL_agg_train),
                    ncomp=30,method = "oscorespls",validation="CV",segments=10)
ncomp_Zn_area_fresh <- selectNcomp(Zn_area_fresh, method = "onesigma", plot = FALSE)
Zn_area_fresh_valid <- which(!is.na(meta(fresh_spec_EL_agg_train)$Zn_area))
Zn_area_fresh_pred<-data.frame(ID=meta(fresh_spec_EL_agg_train)$ID[Zn_area_fresh_valid],
                               Species=meta(fresh_spec_EL_agg_train)$Species[Zn_area_fresh_valid],
                               Project=meta(fresh_spec_EL_agg_train)$Project[Zn_area_fresh_valid],
                               Stage=meta(fresh_spec_EL_agg_train)$Stage[Zn_area_fresh_valid],
                               GrowthForm=meta(fresh_spec_EL_agg_train)$GrowthForm[Zn_area_fresh_valid],
                               measured=meta(fresh_spec_EL_agg_train)$Zn_area[Zn_area_fresh_valid],
...
solubles_area_jack_pred_fresh<-apply.coefs(solubles_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
solubles_area_jack_df_fresh<-data.frame(pred_mean=solubles_area_jack_stat_fresh[,1],
                                        ...
                                        Measured=meta(fresh_spec_EL_agg_test)$solubles_area,
...
hemicellulose_area_jack_pred_fresh<-apply.coefs(hemicellulose_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
hemicellulose_area_jack_df_fresh<-data.frame(pred_mean=hemicellulose_area_jack_stat_fresh[,1],
                                             ...
                                             Measured=meta(fresh_spec_EL_agg_test)$hemicellulose_area,
...
cellulose_area_jack_pred_fresh<-apply.coefs(cellulose_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
cellulose_area_jack_df_fresh<-data.frame(pred_mean=cellulose_area_jack_stat_fresh[,1],
                                         ...
                                         Measured=meta(fresh_spec_EL_agg_test)$cellulose_area,
...
lignin_area_jack_pred_fresh<-apply.coefs(lignin_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
lignin_area_jack_df_fresh<-data.frame(pred_mean=lignin_area_jack_stat_fresh[,1],
                                      ...
                                      Measured=meta(fresh_spec_EL_agg_test)$lignin_area,
...
perC_area_jack_pred_fresh<-apply.coefs(perC_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
perC_area_jack_df_fresh<-data.frame(pred_mean=perC_area_jack_stat_fresh[,1],
                                    ...
                                    Measured=meta(fresh_spec_EL_agg_test)$C_area,
...
perN_area_jack_pred_fresh<-apply.coefs(perN_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
perN_area_jack_df_fresh<-data.frame(pred_mean=perN_area_jack_stat_fresh[,1],
                                    ...
                                    Measured=meta(fresh_spec_EL_agg_test)$N_area,
...
chlA_area_jack_pred_fresh<-apply.coefs(chlA_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
chlA_area_jack_df_fresh<-data.frame(pred_mean=chlA_area_jack_stat_fresh[,1],
                                    ...
                                    Measured=meta(fresh_spec_EL_agg_test)$chlA_area,
...
chlB_area_jack_pred_fresh<-apply.coefs(chlB_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
chlB_area_jack_df_fresh<-data.frame(pred_mean=chlB_area_jack_stat_fresh[,1],
                                    ...
                                    Measured=meta(fresh_spec_EL_agg_test)$chlB_area,
...
car_area_jack_pred_fresh<-apply.coefs(car_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
car_area_jack_df_fresh<-data.frame(pred_mean=car_area_jack_stat_fresh[,1],
                                   ...
                                   Measured=meta(fresh_spec_EL_agg_test)$car_area,
...
Al_area_jack_pred_fresh<-apply.coefs(Al_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
Al_area_jack_df_fresh<-data.frame(pred_mean=Al_area_jack_stat_fresh[,1],
                                  ...
                                  Measured=meta(fresh_spec_EL_agg_test)$Al_area,
...
Ca_area_jack_pred_fresh<-apply.coefs(Ca_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
Ca_area_jack_df_fresh<-data.frame(pred_mean=Ca_area_jack_stat_fresh[,1],
                                  ...
                                  Measured=meta(fresh_spec_EL_agg_test)$Ca_area,
...
Cu_area_jack_pred_fresh<-apply.coefs(Cu_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
Cu_area_jack_df_fresh<-data.frame(pred_mean=Cu_area_jack_stat_fresh[,1],
                                  ...
                                  Measured=meta(fresh_spec_EL_agg_test)$Cu_area,
...
Fe_area_jack_pred_fresh<-apply.coefs(Fe_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
Fe_area_jack_df_fresh<-data.frame(pred_mean=Fe_area_jack_stat_fresh[,1],
                                  ...
                                  Measured=meta(fresh_spec_EL_agg_test)$Fe_area,
...
K_area_jack_pred_fresh<-apply.coefs(K_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
K_area_jack_df_fresh<-data.frame(pred_mean=K_area_jack_stat_fresh[,1],
                                 ...
                                 Measured=meta(fresh_spec_EL_agg_test)$K_area,
...
Mg_area_jack_pred_fresh<-apply.coefs(Mg_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
Mg_area_jack_df_fresh<-data.frame(pred_mean=Mg_area_jack_stat_fresh[,1],
                                  ...
                                  Measured=meta(fresh_spec_EL_agg_test)$Mg_area,
...
Mn_area_jack_pred_fresh<-apply.coefs(Mn_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
Mn_area_jack_df_fresh<-data.frame(pred_mean=Mn_area_jack_stat_fresh[,1],
                                  ...
                                  Measured=meta(fresh_spec_EL_agg_test)$Mn_area,
...
Na_area_jack_pred_fresh<-apply.coefs(Na_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
Na_area_jack_df_fresh<-data.frame(pred_mean=Na_area_jack_stat_fresh[,1],
                                  ...
                                  Measured=meta(fresh_spec_EL_agg_test)$Na_area,
...
P_area_jack_pred_fresh<-apply.coefs(P_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
P_area_jack_df_fresh<-data.frame(pred_mean=P_area_jack_stat_fresh[,1],
                                 ...
                                 Measured=meta(fresh_spec_EL_agg_test)$P_area,
...
Zn_area_jack_pred_fresh<-apply.coefs(Zn_area_jack_coefs_fresh,as.matrix(fresh_spec_EL_agg_test))
...
Zn_area_jack_df_fresh<-data.frame(pred_mean=Zn_area_jack_stat_fresh[,1],
                                  ...
                                  Measured=meta(fresh_spec_EL_agg_test)$Zn_area,
